...
export default function Login({ changeStatus }) {
    ...
    function handleLogin() {
        ...
        if(type === 'login') {
            ...
            .catch( (err)=> {
                console.log(err);
                alert('Ops parece que teve algum erro')
                return;
            })
        }else {
            //Cadastrar o usuario
...
//Renderização Condicional: Se o type for igual ao login irá mostrar criar conta SENÃO irá mostrar botão de fazer login
//{ type === 'login' ? 'Criar uma Conta' : 'Fazer Login'}
